...
/**
 * FilePlugin for Mongoose
 *
 * ex: var fileplugin = require('mongoose-file');
 *     var SomeSchema = new mongoose.Schema({});
 *     SomeSchema.plugin(fileplugin, options);
 *
 * options.before / options.after = functions hooks run on the file
 */

function FilePlugin(schema, options) {
